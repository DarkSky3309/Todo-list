            ...
            <div className="flex items-center justify-center flex-col">{toDoList.length === 0 ?
                ...
                (<div className={"container mx-auto mt-6"}>
                    <div className={"flex justify-center mb-6"}>
                        <select className="p-1 outline-none dark:bg-slate-900 dark:text-white" onChange={e => handleSort(e.target.value)}>
                ...
                <button onClick={() => {setShowModal(true); setNewTask(null)}}
